...
const words = {
  'Il Corpo': [
    ...
    { it:'il sangue', es:'la sangre', type:'noun', g:'m', art:'il', pl:'i sangui (rarissimo)', ex_it:"C'è del sangue sulla camicia.", ex_es:'Hay sangre en la camisa.', lv:'A2', notes:'Normalmente usato solo al singolare. Il plurale "i sangui" è rarissimo e letterario.' },
  ...
  'Colori': [
    ...
    { it:'arancione', es:'naranja', type:'adjective', ex_it:'Il tramonto è arancione.', ex_es:'El atardecer es naranja.', lv:'A1', notes:'Spesso invariabile (fiori arancione), ma anche "arancioni" è accettato. Dipende dal contesto.' },
  ...
  'Verbi Frequenti': [
    ...
    { it:'avere', es:'tener / haber', type:'verb', ex_it:'Ho tre sorelle. Ho mangiato.', ex_es:'Tengo tres hermanas. He comido.', lv:'A1', notes:'Ausiliare per i verbi transitivi e molti intransitivi. La scelta tra avere ed essere va imparata verbo per verbo.', col:'["avere fame","avere voglia","avere bisogno"]' },
    ...
    { it:'potere', es:'poder', type:'verb', ex_it:'Puoi aiutarmi? — Sì, posso.', ex_es:'¿Puedes ayudarme? — Sí, puedo.', lv:'A1', notes:'Verbo modale — di solito regge un infinito, che può essere sottinteso se chiaro dal contesto (es: "Puoi venire?" "Sì, posso.").' },
    ...
    { it:'sentire', es:'oír / sentir', type:'verb', ex_it:'Sento un rumore. Non mi sento bene.', ex_es:'Oigo un ruido. No me siento bien.', lv:'A1', notes:'Sentire = oír/percibir/sentir. Ascoltare = escuchar deliberadamente. Es: "Sento un rumore" (oigo) vs "Ascolto la musica" (escucho).', col:'["sentirsi bene/male","senti!","non sentire"]' },
    ...
    { it:'pensare', es:'pensar', type:'verb', ex_it:'Penso che sia una buona idea. / Penso di partire domani.', ex_es:'Pienso que es una buena idea. / Pienso salir mañana.', lv:'A2', notes:'Pensare che + congiuntivo (soggetti diversi). Stesso soggetto: pensare di + infinito (es: "Penso di partire").', col:'["pensare a","pensarci","che ne pensi?"]' },
    { it:'credere', es:'creer', type:'verb', ex_it:'Non credo che sia vero. / Credo di aver capito.', ex_es:'No creo que sea verdad. / Creo haberlo entendido.', lv:'A2', notes:'Credere che + congiuntivo (soggetti diversi). Stesso soggetto: credere di + infinito (es: "Credo di aver capito").', col:'["crederci","non ci credo"]' },
    { it:'sperare', es:'esperar', type:'verb', ex_it:'Spero che tu stia bene. / Spero di riuscirci.', ex_es:'Espero que estés bien. / Espero lograrlo.', lv:'B1', notes:'Sperare che + congiuntivo (soggetti diversi). Stesso soggetto: sperare di + infinito (es: "Spero di riuscirci").', col:'["sperare in","speriamo!"]' },
    ...
    { it:'tenere', es:'sostener / mantener / guardar', type:'verb', ex_it:'Tieni il bicchiere. Tienilo presente.', ex_es:'Sostén el vaso. Tenlo en cuenta.', lv:'B1', notes:'Tenere ≠ "tener" (poseer): usare "avere" per il possesso. Tenere = sostenere, mantenere, custodire, tener sujeto.', col:'["tenerci","tenere in mente","tener duro","tenere aperto"]' },
  ...
  'Falsi Amici': [
    ...
    { it:'sensibile', es:'sensible / emotivo', type:'adjective', ex_it:'È una persona molto sensibile.', ex_es:'Es una persona muy sensible.', lv:'B1', false_f:'"Sensibile" y "sensible" (es.) son equivalentes en muchos contextos (emocionalmente sensible). El falso amigo es con el inglés "sensible" (= "sensato" en italiano).' },
    ...
    { it:'la camera', es:'la habitación / el dormitorio (NO la cámara)', type:'noun', g:'f', art:'la', pl:'le camere', ex_it:'La camera da letto è al primo piano.', ex_es:'El dormitorio está en el primer piso.', lv:'A2', false_f:'"Camera" en italiano = habitación. "Camera da letto" = dormitorio. La cámara fotográfica = "la macchina fotografica" o "la fotocamera".', col:'["camera da letto","camera singola","camera matrimoniale"]' },
    ...
    { it:'conveniente', es:'conveniente / económico / adecuado', type:'adjective', ex_it:'Ho trovato un hotel molto conveniente.', ex_es:'Encontré un hotel muy económico.', lv:'B1', false_f:'"Conveniente" puede significar barato/económico, pero también apropiado, ventajoso u oportuno. No equivale únicamente a "barato".' },
  ...
  'Emozioni': [
    ...
    { it:"l'entusiasmo", es:'el entusiasmo', type:'noun', g:'m', art:"l'", ex_it:'Studia con molto entusiasmo.', ex_es:'Estudia con mucho entusiasmo.', lv:'B1' },
  ...
  'Aggettivi': [
    ...
    { it:'buono', es:'bueno', type:'adjective', ex_it:'Questo risotto è buonissimo! Buon ragazzo, buono zio.', ex_es:'¡Este risotto está buenísimo! Buen chico, buen tío.', lv:'A1', notes:"Come l'articolo \"un\": buon ragazzo, buon amico, buono studente, buono zio; buona ragazza, buon'amica; buoni amici, buone idee.", col:'["di buon umore","buona fortuna!","buon appetito"]' },
